...
public class BlockSetTypeUtil {
    public BlockSetType of(String name,
    ...
    public BlockSetType ofWood(String name,
                               SoundType soundType,
    ...
    public BlockSetType ofNetherWood(String name) {
    ...
    public BlockSetType ofBambooWood(String name) {
    ...
    public BlockSetType ofCherryWood(String name) {
    ...
    public BlockSetType ofStone(String name) {
    ...
    public BlockSetType fromCopy(String name, BlockSetType baseType) {
